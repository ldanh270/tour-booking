                ...
                <div className="mt-10 grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
                    {ARTICLES.map((art) => (
                        ...
                        >
                            ...
                            <button className="border-primary-foreground text-foreground hover:bg-primary-foreground mx-2 my-4 inline-flex w-fit cursor-pointer items-center gap-2 rounded-full border px-4 py-2 text-sm font-medium transition hover:text-white">
                                Read More →
                            </button>
                        </div>
                    ))}
